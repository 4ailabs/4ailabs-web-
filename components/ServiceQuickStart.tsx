...
const ServiceQuickStart: React.FC<ServiceQuickStartProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl max-w-sm sm:max-w-md md:max-w-2xl lg:max-w-4xl w-full max-h-[90vh] overflow-hidden mx-2 sm:mx-4">
        {/* Header */}
